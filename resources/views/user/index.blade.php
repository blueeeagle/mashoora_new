            ...
            <div class="card-body" id="kt_engage_demos_body">
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4" data-id-filter="phone" hidden>
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos1_body" data-kt-scroll-dependencies="#kt_engage_demos1_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="fv-row mb-12">
                        <select class="form-select" id="toogleColum" data-control="select2" data-placeholder="Toggle column" multiple="multiple">
                            ...
                            <option selected value="4">Image</option>
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Admin List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        $(document).ready(function () {
            table = $("#kt_customers_table").DataTable({
                ...
                ajax: {
                    ...
                    data: {
                        "_token": "{{ csrf_token() }}",
                        columnsDef : ['id','picture','name','country','status']
                    }
                ...
                columnDefs : [
                    ...
                    },
                    {
                        ...
                        orderable: true,
                        render: function (data, type, row) {
                            return `Name : ${row.first_name} ${row.last_name}<br/>
                            Email : ${row.email}<br/>Phone No : ${row.country?.dialing || ''} ${row.phone}`
                        },
                    },
                    {
                        targets: 3,
                        ...
                        render: function (data, type, row) {
                            let Template = ''
                            if(row.country) Template += `Country : ${row.country.country_name}<br/>`
                            if(row.state) Template += `State : ${row.state.state_name}<br/>`
                            if(row.city) Template += `City : ${row.city.city_name}<br/>`
                            return Template
                        },
                    },
                ],
