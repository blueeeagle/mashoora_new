                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos1_body" data-kt-scroll-dependencies="#kt_engage_demos1_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="fv-row mb-12">
                        <select class="form-select" id="toogleColum" data-control="select2" data-placeholder="Toggle column" multiple="multiple">
                            ...
                            <option selected value="3">Last Config</option>
                            <option selected value="4">Last Update</option>
                            <option selected value="5">Schedule</option>
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Calendar List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
    ...
    var table = null;
        $(document).ready(function () {
            table = $("#kt_customers_table").DataTable({
                ...
                ajax: {
                    url : "{{route('activities.calendar.datatable')}}",
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        columnsDef : ['id','name','Schedule_type','Last_Config','lastUpDate','scheduleOrNot']
                    }
