<x-base-layout>
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <button class="btn btn-flex btn-primary" data-kt-calendar="add" hidden>
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header border-0 justify-content-end">
                        <!--begin::Edit-->
                        <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="tooltip" hidden data-bs-dismiss="click" title="Edit Event" id="kt_modal_view_event_edit">
                        ...
                        <!--end::Edit-->
                        <!--begin::Edit-->
                        <div class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-danger me-2" data-bs-toggle="tooltip" hidden data-bs-dismiss="click" title="Delete Event" id="kt_modal_view_event_delete">
                  ...
                  <div class="modal-body pt-0 pb-20 px-lg-17" id="appnotfound" hidden> <!--begin::Row-->
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div class="fs-6">
                            <span class="fw-bolder">ch</span>
                            <span data-kt-calendar="c_name"></span>
                        </div>
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <!--begin::Event start date/time-->
                        <div class="fs-6">
                            <span class="fw-bolder">ht</span>
                            <span data-kt-calendar="app_type"></span>
                        </div>
                        <!--end::Event start date/time-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <!--begin::Event start date/time-->
                        <div class="fs-6">
                            <span class="fw-bolder">hs</span>
                            <span data-kt-calendar="app_status"></span>
                        </div>
                        <!--end::Event start date/time-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="modal-body pt-0 pb-20 px-lg-17" hidden id="appfound">
                        <!--begin::Row-->
                        <span class="fs-3 fw-bolder me-3" id="map_id" data-kt-calendar="map_id" hidden></span>
                        <div class="d-flex"> 
                            <!--begin::Icon-->
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-1 svg-icon-muted me-5">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="fs-6">
                                ...
                                <span data-kt-calendar="c_name"></span>
                                <span class="badge badge-light-primary" data-kt-calendar= "app_status" ></span>
                            </div>
                            <!--end::Event start date/time-->
                        </div>
                        <!--end::Row-->
    ...
    <script src="{{ URL::asset(theme()->getDemo().'/js/calendarAppointment.js') }}"></script>
    <script>
        ...
        const popup_edit = document.getElementById('kt_modal_view_event_edit');
        const popup_delete = document.getElementById('kt_modal_view_event_delete');
