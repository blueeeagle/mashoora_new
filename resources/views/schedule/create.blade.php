<x-base-layout>
                                                            ...
                                                            <div class="inner-repeater">
                                                                <div data-repeater-list="kt_docs_repeater_nested_inner" class="mb-5">
                                                                    <div data-repeater-item>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group row videtodireact">
                                                                                @if($consultant->video)
                                                                                <div class="col-md-6">
    ...
    <script>
        ...
        $(document).on('change', '.checkboxOnOff', function(){
            ...
            const dataRepeaterCreate = parent.querySelector('button[data-repeater-create]')
            const DeleteButton = [...parent.querySelectorAll('button[data-repeater-delete]')]
            const timeInput = [...parent.querySelectorAll('input[type=time]')]
            const properitycheckbox = [...parent.querySelector('.videtodireact').querySelectorAll('input')]

            if(!inputCheckbox.checked){
                DeleteButton.forEach(e => $(e).trigger( "click" ))
                properitycheckbox.forEach(e => (e.checked = false,e.disabled = true))
                timeInput.forEach(e => (e.disabled = true,e.value = '',e.required = false))
                dataRepeaterCreate.disabled = true
            }else{
                timeInput.forEach(e => (e.disabled = false,e.required = true))
                properitycheckbox.forEach(e => e.disabled = false)
                dataRepeaterCreate.disabled = false
