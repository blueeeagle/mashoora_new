        ...
        <div class="card shadow-none rounded-0 w-100">
            ...
            <div class="card-body" id="kt_engage_demos_body">
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="row">
                        <div class="col-xxl-4" data-id-filter="firm" hidden>
                            <select name="" id="" class="form-select form-select-solid datatable-input" data-control="select2"  data-col-index='2'>
                                ...
                                @foreach($firm as $firm)
                                    <option  value="{{$firm->id}}">{{$firm->company_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Offer List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('other.offer.create') }}" class="btn btn-sm btn-primary" >Create</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
    ...
    var table = null;
        $(document).ready(function () {
            table = $("#kt_customers_table").DataTable({
                ...
                ajax: {
                    url : "{{route('other.offer.datatable')}}",
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
