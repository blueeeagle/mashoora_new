                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="fv-row mb-12">
                        <select class="form-select form-select-solid" data-control="select2" data-placeholder="Search option" data-allow-clear="true" id="filter" multiple="multiple">
                            <option value="post_from">Post From</option>
                            <option value="video">Video Title</option>
                            <option value="url">Video URL</option>
                            <option value="sort">Sort No</option>
                            
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-xxl-4" data-id-filter="post_from" hidden>
                    ...
                    <div class="row">
                        <div class="col-xxl-4" data-id-filter="video" hidden>
                            <label class="fs-6 form-label fw-bolder text-dark">Video Title</label>
                            <input type="text" class="form-control form-control form-control-solid datatable-input" data-col-index='2' />

                        </div>                        
                    </div>
                    <div class="row">
                        <div class="col-xxl-4" data-id-filter="url" hidden>
                        <label class="fs-6 form-label fw-bolder text-dark">Pos From</label>
                    ...
                    <div class="row">
                        <div class="col-xxl-4" data-id-filter="sort" hidden>
                            <label class="fs-6 form-label fw-bolder text-dark">Sort No</label>
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos1_body" data-kt-scroll-dependencies="#kt_engage_demos1_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="fv-row mb-12">
                        <select class="form-select" id="toogleColum" data-control="select2" data-placeholder="Toggle column" multiple="multiple">
                            ...
                            <option selected value="1">Post From</option>
                            <option selected value="2">Video Title</option>
                            <option selected value="3">Video URL</option>
                            <option selected value="4">Sort No</option>
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('other.video.create') }}" class="btn btn-sm btn-primary" >Create</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
    ...
    var table = null;
        $(document).ready(function () {
            table = $("#kt_customers_table").DataTable({
                ...
                ajax: {
                    url : "{{route('other.video.datatable')}}",
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        columnsDef : ['id','fromuser','video_title','video_url','sort_no']
                    }
