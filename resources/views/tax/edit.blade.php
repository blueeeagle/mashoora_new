            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body rounded border pt-0">
                        <form action="{{ route('master.tax.update',$tax->id) }}" method="Post" id="formEdit">
                            @csrf
                            <div class="py-5">
                                <div class="p-10">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Title" value="{{ $tax->title }}" required/>
                                    </div>
                                     <div class="mb-10">
                                        ...
                                        <div class="input-group mb-5">
                                            ...
                                            <input type="number" id="tax_value" name="tax_value" class="form-control" onkeyup="validateamount()" placeholder="Enter Percentage" value="{{ $tax->tax_value }}" required/>
                                        </div>
                                    </div>
                                    </div>
