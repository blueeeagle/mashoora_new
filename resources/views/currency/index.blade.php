        ...
        <div class="card shadow-none rounded-0 w-100">
            ...
            <div class="card-body" id="kt_engage_demos_body">
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="row">
                        <div class="col-xxl-10" data-id-filter="countrycode" hidden>
                        ...
                        <div class="col-xxl-10" data-id-filter="currencycode" hidden>
                            <label class="fs-6 form-label fw-bolder text-dark">Currency Code</label>
                            <input type="text" class="form-control form-control form-control-solid datatable-input" data-col-index='3' />
                        </div>
                        <div class="col-xxl-10" data-id-filter="price" hidden>
                            <label class="fs-6 form-label fw-bolder text-dark">Price</label>
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Currency List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
    ...
    firebase.initializeApp(config);
        $(document).ready(function () {
            ...
            table = $("#kt_customers_table").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url : "{{route('master.currency.datatable')}}",
                    type: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        columnsDef : ['id','countryname','countrycode','price','symbol','action']
                    }
