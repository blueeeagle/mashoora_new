                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_engage_demos_body" data-kt-scroll-dependencies="#kt_engage_demos_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="fv-row mb-12">
                        <select class="form-select form-select-solid" data-control="select2" data-placeholder="Search option" data-allow-clear="true" id="filter" multiple="multiple">
                            <option value="county_name">Country Name</option>
                            <option value="country_code">Country Code</option>
                            <option value="dialing">Dialing</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-xxl-10" data-id-filter="county_name" hidden>
                            <label class="fs-6 form-label fw-bolder text-dark">Country Name</label>
                            <input type="text" class="form-control form-control  datatable-input" data-col-index='1' />
                        </div>
                        <div class="col-xxl-10" data-id-filter="country_code" hidden>
                            <label class="fs-6 form-label fw-bolder text-dark">Country Code</label>
                            <input type="text" class="form-control form-control  datatable-input" data-col-index='2' />
                        </div>
                        <div class="col-xxl-10" data-id-filter="dialing" hidden>
                            <label class="fs-6 form-label fw-bolder text-dark">Dialing</label>
                            <input type="text" class="form-control form-control  datatable-input" data-col-index='3' />
                        </div>
                    </div>
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Country List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    {{-- <a href="{{ route('master.currency.create') }}" class="btn btn-sm btn-primary" >Create</a> --}}
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
        ...
        $(document).ready(function () {
            ...
            table = $("#kt_customers_table").DataTable({
                ...
                ajax: {
                    ...
                    data: {
                        "_token": "{{ csrf_token() }}",
                        columnsDef : ['id','country_name','country_code','dialing','status','has_state','action']
                    }
