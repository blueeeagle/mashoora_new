<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="text-center">
            ...
            <!--begin::Google link-->
            <a href="{{ url('/auth/redirect/google') }}?redirect_uri={{ url()->previous() }}" class="btn btn-flex d-none flex-center btn-light btn-lg w-100 mb-5">
            ...
            <!--begin::Facebook link-->
            <a href="{{ url('/auth/redirect/facebook') }}?redirect_uri={{ url()->previous() }}" class="btn btn-flex d-none flex-center btn-light btn-lg w-100 mb-5">
