...
var KTStepper = function(element, options) {
    ...
    var _init = function() {
        ...
        the.skip = KTUtil.find(the.element, '[data-kt-stepper-action="skip"]');
        ...
        the.skiped =  new Array(the.steps.length);
        // Set Current Step
        ...
        KTUtil.addEvent(the.btnNext, 'click', function(e) {
            e.preventDefault();
            the.skiped[the.currentStepIndex] = true
            KTEventHandler.trigger(the.element, 'kt.stepper.next', the);
        });

        KTUtil.addEvent(the.skip, 'click', function(e) {
            e.preventDefault();
            the.skiped[the.currentStepIndex] = false
            KTEventHandler.trigger(the.element, 'kt.stepper.skip', the);
        });
    ...
    var _refreshUI = function() {
        ...
        if ( elements && elements.length > 0 ) {
            for (var i = 0, len = elements.length; i < len; i++) {
                ...
                KTUtil.removeClass(element, 'skip');
                ...
                if ( index == the.currentStepIndex ) {
                    ...
                    if ( index < the.currentStepIndex ) {
                        if(the.skiped[index] == false) KTUtil.addClass(element, 'skip');
                        else KTUtil.addClass(element, 'completed');
                    } else {
