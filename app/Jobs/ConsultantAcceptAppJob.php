...
class ConsultantAcceptAppJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [169,170,171,172,173,174,175,176];
    public $TYPE = [169=>'pn',170=>'mail',171=>'sms',172=>'pn',173=>'mail',174=>'sms',175=>'pn',176 =>'mail'];

    //Identify Data Type
    public $customerKEY = [169,170,171];
    public $consultantKEY = [172,173,174];
    public $AdminKEY = [175,176];
