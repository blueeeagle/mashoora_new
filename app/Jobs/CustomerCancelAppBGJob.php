...
class CustomerCancelAppBGJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [113,114,115,116,117,118,119,120];
    public $TYPE = [49=>'pn',114=>'mail',115=>'sms',116=>'pn',117=>'mail',118=>'sms',119=>'pn',120 =>'mail'];

    //Identify Data Type
    public $customerKEY = [49,114,115];
    public $consultantKEY = [116,117,118];
    public $AdminKEY = [119,120];
