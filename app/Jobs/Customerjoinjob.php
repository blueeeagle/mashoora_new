...
class Customerjoinjob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [49,50,51,52,53,54,55,56];
    public $TYPE = [49=>'pn',50=>'mail',51=>'sms',52=>'pn',53=>'mail',54=>'sms',55=>'pn',56 =>'mail'];

    //Identify Data Type
    public $customerKEY = [49,50,51];
    public $consultantKEY = [52,53,54];
    public $AdminKEY = [55,56];
