...
class CustomerRescheduleBGJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [137,138,139,140,141,142,143,144];
    public $TYPE = [137=>'pn',138=>'mail',139=>'sms',140=>'pn',141=>'mail',142=>'sms',143=>'pn',144 =>'mail'];

    //Identify Data Type
    public $customerKEY = [137,138,139];
    public $consultantKEY = [140,141,142];
    public $AdminKEY = [143,144];
