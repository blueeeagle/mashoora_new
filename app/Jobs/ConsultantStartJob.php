...
class ConsultantStartJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [41,42,43,44,45,46,47,48];
    public $TYPE = [41=>'pn',42=>'mail',43=>'sms',44=>'pn',45=>'mail',46=>'sms',47=>'pn',48 =>'mail'];

    //Identify Data Type
    public $customerKEY = [41,42,43];
    public $consultantKEY = [44,45,46];
    public $AdminKEY = [47,48];
