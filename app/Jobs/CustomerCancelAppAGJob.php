...
class CustomerCancelAppAGJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [121,122,123,124,125,126,127,128];
    public $TYPE = [121=>'pn',122=>'mail',123=>'sms',124=>'pn',125=>'mail',126=>'sms',127=>'pn',128 =>'mail'];

    //Identify Data Type
    public $customerKEY = [121,122,123];
    public $consultantKEY = [124,125,126];
    public $AdminKEY = [127,128];
