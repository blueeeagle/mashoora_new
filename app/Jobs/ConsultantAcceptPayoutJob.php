...
class ConsultantAcceptPayoutJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [193,194,195,196,197,198,199,200];
    public $TYPE = [193=>'pn',194=>'mail',195=>'sms',196=>'pn',197=>'mail',198=>'sms',199=>'pn',200 =>'mail'];

    //Identify Data Type
    public $customerKEY = [193,194,195];
    public $consultantKEY = [196,197,198];
    public $AdminKEY = [199,200];
