...
class CustomerBookedJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [17,18,19,20,21,22,23,24];
    public $TYPE = [17=>'pn',18=>'mail',19=>'sms',20=>'pn',21=>'mail',22=>'sms',23=>'pn',24 =>'mail'];

    //Identify Data Type
    public $customerKEY = [17,18,19];
    public $consultantKEY = [20,21,22];
    public $AdminKEY = [23,24];
    ...
    function Notification($value){
        Log::info($this->Appointment->customer->notifiation_token);
