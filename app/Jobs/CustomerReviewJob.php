...
class CustomerReviewJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [73,74,75,76,77,78,79,80];
    public $TYPE = [73=>'pn',74=>'mail',75=>'sms',76=>'pn',77=>'mail',78=>'sms',79=>'pn',80 =>'mail'];

    //Identify Data Type
    public $customerKEY = [73,74,75];
    public $consultantKEY = [76,77,78];
    public $AdminKEY = [79,80];
