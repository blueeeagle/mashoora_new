...
class PayinDeclineJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [105,106,107,108,109,110,111,112];
    public $TYPE = [105=>'pn',106=>'mail',107=>'sms',108=>'pn',109=>'mail',110=>'sms',111=>'pn',112 =>'mail'];

    //Identify Data Type
    public $customerKEY = [105,106,107];
    public $consultantKEY = [108,109,110];
    public $AdminKEY = [111,112];
