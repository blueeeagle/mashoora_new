...
class ConsultantCancelJob implements ShouldQueue
{
    ...
    public $NotificationSettingIDS = [129,130,131,132,133,134,135,136];
    public $TYPE = [129=>'pn',130=>'mail',131=>'sms',132=>'pn',133=>'mail',134=>'sms',135=>'pn',136 =>'mail'];

    //Identify Data Type
    public $customerKEY = [129,130,131];
    public $consultantKEY = [132,133,134];
    public $AdminKEY = [135,136];
